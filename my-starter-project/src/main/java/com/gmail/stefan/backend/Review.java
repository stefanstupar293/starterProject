...
public class Review implements Serializable {
    ...
    private int count;
    private User taster;
    private Beverage beverage; 						//last added
    ...
    public Review(int score, String name, LocalDate date, Category category,
            int count, User taster, Beverage beverage) {
        this.score = score;
        this.name = name;
        this.date = date;
        this.category = new Category(category);
        this.count = count;
        this.taster= new User(taster);
        this.beverage = new Beverage(beverage);
	...
	public void setTaster(User user) {
		this.taster = user;
	}
    ...
    public String toString() {
        ...
        return "Review{" + "id=" + getId() + ", score=" + getScore() + ", name="
                ...
                + getDate() + ", count=" + getCount() +", taster" + getTaster() +", beverage" + getBeverage() + '}';   										 //get taster
    }
