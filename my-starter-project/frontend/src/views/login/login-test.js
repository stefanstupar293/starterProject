...
<vaadin-vertical-layout style="width: 100%; height: 100%;">
 ...
 <vaadin-text-field label="Email:" placeholder="User Email" id="emailInput" required="true" autofocus="true" style="align-self: center"></vaadin-text-field>
 ...
 <vaadin-horizontal-layout style="align-self: center">
  ...
  <vaadin-vertical-layout theme="spacing" id="vaadinVerticalLayout" style="width: 25px"></vaadin-vertical-layout>
