...
public class AppUserWebServices  implements  Serializable{
	...
	public static AppUserWebServices getUserWebServices() {
		return userWebServices;
	}


	public static void setUserWebServices(AppUserWebServices userWebServices) {
		AppUserWebServices.userWebServices = userWebServices;
	}
